...
response = requests.get("https://api.smitegame.com/smiteapi.svc/createsessionxml/4174/" + signature + "/" + myclient._create_now_timestamp(), verify = True)
#response = requests.get("https://api.smitegame.com/smiteapi.svc/pingxml")
print(response.text)
...
for x in inputArray:
    ...
    if(i % 5 == 0):
        ...
        response2 = requests.get("https://api.smitegame.com/smiteapi.svc/getmatchdetailsbatchxml/4174/" + signature2 + "/" + mySession + "/" + myclient._create_now_timestamp() + "/" + workingArray[0] + "," + workingArray[1] + "," + workingArray[2] + "," + workingArray[3] + "," + workingArray[4], verify = True)
...
if(not(i % 5 == 0)):
    ...
    signature2 = (myclient._create_signature("getmatchdetailsbatch"))
    response2 = requests.get("https://api.smitegame.com/smiteapi.svc/getmatchdetailsbatchxml/4174/" + signature2 + "/" + mySession + "/" + myclient._create_now_timestamp() + "/" + matchIDs, verify = True)
    f = open("stldailydata.txt", "a")
    f.write(response2.text.encode(sys.stdout.encoding, errors='replace').decode(sys.stdout.encoding) )
    f.close()
    workingArray = []
